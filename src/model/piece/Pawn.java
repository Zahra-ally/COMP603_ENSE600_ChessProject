...
public class Pawn extends Piece {
    ...
    //baseRow and rowDirection change depending on the color of pieces
    private final int baseRow = (color == PieceColor.WHITE) ? 1 : 6;
    private final int rowDirection = (color == PieceColor.WHITE) ? 1 : -1;

    /*
        Adding all possible vectors for the pawn the arraylist
 Pawn only moves in one direction        
     */
    @Override
